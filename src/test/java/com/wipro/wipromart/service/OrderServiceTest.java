...
public class OrderServiceTest {
	...
	void testGetOrderByIdWithException() {
		...
		assertThrows(ResourceNotFoundException.class, () -> orderService.getOrderById(20));
	}
	...
	public void testGetAllOrders() {
		...
		assertEquals(100.0, orderList.get(0).getOrderAmount(), 0.01);
		assertEquals(2, orderList.get(1).getOrderId());
		assertEquals("Pending", orderList.get(1).getOrderStatus());
		assertEquals(200.0, orderList.get(1).getOrderAmount(), 0.01);
	}
